...
// Middleware d'authentification pour les clients et les commerciaux
exports.authenticateClient = (req, res, next) => {
  ...
  if (!token && req.method !== 'POST' && req.path !== '/api/clients/register' && req.path !== '/api/clients/login' && req.path !== '/api/commercial/register' && req.path !== '/api/commercial/login') {
  ...
  jwt.verify(bearer, secret, (err, decoded) => {
    if (err && req.method !== 'POST' && req.path !== '/api/clients/register' && req.path !== '/api/clients/login' && req.path !== '/api/commercial/register' && req.path !== '/api/commercial/login') {
