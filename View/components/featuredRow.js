...
export default function FeaturedRow() {
    ...
    useEffect(() => {
        getAllRestaurantInfos().then((data) => {
            ...
            setRestaurantCategories(Object.keys(data))
            console.log(data)
    ...
    return (
        <View>
            {Array.isArray(restaurantCategories) && restaurantCategories.map((category, index) => (
                <View>
                    ...
                    <ScrollView
                        ...
                        {restaurantInfos[category].map((restaurant, rIndex) => (
                            <View>
                                <TouchableOpacity onPress={() => { navigation.navigate('Restaurant', { restaurantInfos: restaurant }) }} style={{ backgroundColor: 'white', width: 290, height: 250, borderRadius: 20, marginRight: 20 }}>
