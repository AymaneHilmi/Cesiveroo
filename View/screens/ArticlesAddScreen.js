import { View, Text, TouchableOpacity, Image, TextInput, ScrollView, TouchableWithoutFeedback, Keyboard } from 'react-native';
...
export default function ArticlesAddScreen() {
    ...
    const handleCreateArticle = async () => {
        try {
            ...
            const response = await createArticle(restaurantId, name, ingredients, price);
