...
export default function CartScreen() {
    ...
    return (
        ...
        <View style={{ flex: '1 1 0 %', backgroundColor: '#ffffff', marginTop: 50 }}>
            {/* top button */}
            < View style={{
            ...
            >
                ...
                <View
                    ...
                    <Text className="font-semibold text-base">$22,99</Text>
                    <TouchableOpacity
                ...
                <View
                    ...
                    <Text style={{ color: themeColors.text }} className="font-bold">2 x </Text>
                    <Image className="h-14 w-14 rounded-full" source={require('../assets/images/pizzaDish.png')} />
                    <Text className="flex-1 font-bold text-gray-700">Pizza Kebab</Text>
                    <Text className="font-semibold text-base">$22,99</Text>
                    <TouchableOpacity
                        className="p-1 rounded-full"
                        style={{ backgroundColor: themeColors.bgColor(1) }}
